...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('App_handtime', '0005_remove_addproduct_producttype'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('made_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='transactions', to='App_handtime.user')),
            ],
        ),
    ]
